...
import { TCategoryResult } from "@/app/dashboard/tasks/types/TResult";
 ...
 */
export function getCategory(row: TTask): TCategoryResult {
 ...
 */
export function getValue(row: any, keys: string[], fallback = "-") {
