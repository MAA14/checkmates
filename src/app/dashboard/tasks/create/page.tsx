...
async function insertTaskSelections(taskId: string, selections: any[]) {
...
export default function InputKegiatan() {
  ...
  function handleSelectionChange(variabelId: number, opsiId: number) {
  ...
  function validate() {
    ...
    const allSelected = PRIORITY_VARIABLES.every(
      (v) => selections[v.id] != null,
    );
    if (!allSelected)
      return "Semua variabel penilaian prioritas harus dipilih.";
    return null;
  }
    ...
    <>
      ...
      <div className="ik-page">
        ...
        <div className="ik-heading">
          ...
          <p className="ik-subtitle">
            Tambahkan kegiatan baru ke dalam sistem CheckMates
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="ik-actions">
              ...
              <button
                ...
                onClick={() => router.push(routeUrl.dashboard)}
                disabled={loading}
              >
                Batal
              </button>
