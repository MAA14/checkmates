...
const TAB_LABELS: TResultLabels = {
  semua: "Semua",
...
export default function Tasks() {
  ...
  const filtered = useMemo(() => {
    return rows.filter((row) => {
      ...
      if (
        ...
        getPriorityClass(Number(row.total_priority_score || 0)) !==
          priorityFilter
      )
        return false;
      return true;
  ...
  return (
    <section className="page-transition">
      ...
      <div className="stack">
        {loading && (
          <div className="state-card glass-card">Memuat data kegiatan...</div>
        )}
        {!loading && error && (
