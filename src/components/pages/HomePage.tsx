...
import { TFeature, TSteps } from "../types/THomePage";
...
export function HomePage({ data }: THomePage) {
    ...
    <main className="onboarding-page page-transition">
      <header className="landing-nav glass-card">
        ...
        <div className="landing-actions">
          <Link className="ghost-button" href={routeUrl.register}>
            Daftar
          </Link>
      ...
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <p>
            CheckMates membantu kamu memilih langkah terbaik: kegiatan mana yang
            harus dikerjakan dulu, mana yang mulai mendesak, dan deadline mana
          ...
          <div className="hero-actions">
            ...
            <a className="ghost-button large" href="#fitur">
              Lihat Fitur
            </a>
          </div>
        </div>
        ...
        <div className="hero-card glass-card">
          <div className="hero-board">
            <img src={mascotSrc} alt="Mascot kuda CheckMates" />
      ...
      <section className="section-block split-section">
        <div className="glass-card explain-card">
          ...
          <p>
            CheckMates tetap memakai logic Supabase dan sistem prioritas yang
            sudah ada di project kamu. Onboarding ini hanya menjadi halaman
            pembuka sebelum user masuk ke login.
          </p>
      ...
      <section className="cta-section glass-card">
        <div>
          ...
          <p>
            Login, tambahkan kegiatan, lalu biarkan CheckMates membantu
            mengurutkan prioritasmu.
          </p>
        </div>
        <button
          className="primary-button large"
